Created by [FlyoverWorks](http://www.flyoverworks.com) for use with [Inked](https://www.inkedcrm.com). Also, special thanks for contributions from the team at [Inkling Markets](http://inklingmarkets.com/).
